...
static CDataSprite x44[] = {
	...
	/* x44[92] */ {  "browse_norank",  &x28[3],  4,  0,  1,  1, },
	...
	/* x44[102] */ {  "file_demo1",  &x28[7],  0,  0,  1,  1, },
	/* x44[103] */ {  "file_demo2",  &x28[7],  1,  0,  1,  1, },
	/* x44[104] */ {  "file_folder",  &x28[7],  2,  0,  1,  1, },
	/* x44[105] */ {  "file_map1",  &x28[7],  5,  0,  1,  1, },
	/* x44[106] */ {  "file_map2",  &x28[7],  6,  0,  1,  1, },
	/* x44[107] */ {  "guibutton_off",  &x28[8],  0,  0,  4,  4, },
	/* x44[108] */ {  "guibutton_on",  &x28[8],  4,  0,  4,  4, },
	/* x44[109] */ {  "guibutton_hover",  &x28[8],  8,  0,  4,  4, },
	/* x44[110] */ {  "guiicon_mute",  &x28[9],  0,  0,  4,  2, },
	/* x44[111] */ {  "guiicon_friend",  &x28[9],  4,  0,  4,  2, },
	/* x44[112] */ {  "audio_source",  &x28[11],  0,  0,  1,  1, },
};
static CAnimKeyframe x4406[] = {
	/* x4406[0] */ {  0.000000f,  0.000000f,  -4.000000f,  0.000000f, },
};
static CAnimKeyframe x4413[] = {
	/* x4413[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe x4420[] = {
	/* x4420[0] */ {  0.000000f,  0.000000f,  10.000000f,  0.000000f, },
};
static CAnimKeyframe *x4427 = 0;
static CAnimKeyframe *x4451 = 0;
static CAnimKeyframe x4458[] = {
	/* x4458[0] */ {  0.000000f,  -7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4465[] = {
	/* x4465[0] */ {  0.000000f,  7.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe *x4472 = 0;
static CAnimKeyframe *x4491 = 0;
static CAnimKeyframe x4498[] = {
	/* x4498[0] */ {  0.000000f,  -3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe x4505[] = {
	/* x4505[0] */ {  0.000000f,  3.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4512 = 0;
static CAnimKeyframe x4531[] = {
	/* x4531[0] */ {  0.000000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4531[1] */ {  0.200000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4531[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4531[3] */ {  0.600000f,  0.000000f,  0.000000f,  0.000000f, },
	/* x4531[4] */ {  0.800000f,  0.000000f,  -1.000000f,  0.000000f, },
	/* x4531[5] */ {  1.000000f,  0.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4538[] = {
	/* x4538[0] */ {  0.000000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4538[1] */ {  0.200000f,  -8.000000f,  0.000000f,  0.000000f, },
	/* x4538[2] */ {  0.400000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4538[3] */ {  0.600000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4538[4] */ {  0.800000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4538[5] */ {  1.000000f,  8.000000f,  0.000000f,  0.000000f, },
};
static CAnimKeyframe x4545[] = {
	/* x4545[0] */ {  0.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
	/* x4545[1] */ {  0.200000f,  -8.000000f,  -8.000000f,  0.300000f, },
	/* x4545[2] */ {  0.400000f,  4.000000f,  -4.000000f,  -0.200000f, },
	/* x4545[3] */ {  0.600000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4545[4] */ {  0.800000f,  8.000000f,  0.000000f,  0.000000f, },
	/* x4545[5] */ {  1.000000f,  -10.000000f,  -4.000000f,  0.200000f, },
};
static CAnimKeyframe *x4552 = 0;
static CAnimKeyframe *x4651 = 0;
static CAnimKeyframe *x4658 = 0;
static CAnimKeyframe *x4665 = 0;
static CAnimKeyframe x4672[] = {
	/* x4672[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.100000f, },
	/* x4672[1] */ {  0.300000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4672[2] */ {  0.400000f,  0.000000f,  0.000000f,  0.300000f, },
	/* x4672[3] */ {  0.500000f,  0.000000f,  0.000000f,  0.250000f, },
	/* x4672[4] */ {  1.000000f,  0.000000f,  0.000000f,  -0.100000f, },
};
static CAnimKeyframe *x4706 = 0;
static CAnimKeyframe *x4713 = 0;
static CAnimKeyframe *x4720 = 0;
static CAnimKeyframe x4727[] = {
	/* x4727[0] */ {  0.000000f,  0.000000f,  0.000000f,  -0.250000f, },
	/* x4727[1] */ {  0.100000f,  0.000000f,  0.000000f,  -0.050000f, },
	/* x4727[2] */ {  0.150000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4727[3] */ {  0.420000f,  0.000000f,  0.000000f,  0.400000f, },
	/* x4727[4] */ {  0.500000f,  0.000000f,  0.000000f,  0.350000f, },
	/* x4727[5] */ {  1.000000f,  0.000000f,  0.000000f,  -0.250000f, },
};
static CAnimation x75[] = {
	/* x75[0] */ {  "base",  /* x75[0].body */ {  1,x4406, },  /* x75[0].back_foot */ {  1,x4413, },  /* x75[0].front_foot */ {  1,x4420, },  /* x75[0].attach */ {  0,x4427, }, },
	/* x75[1] */ {  "idle",  /* x75[1].body */ {  0,x4451, },  /* x75[1].back_foot */ {  1,x4458, },  /* x75[1].front_foot */ {  1,x4465, },  /* x75[1].attach */ {  0,x4472, }, },
	/* x75[2] */ {  "inair",  /* x75[2].body */ {  0,x4491, },  /* x75[2].back_foot */ {  1,x4498, },  /* x75[2].front_foot */ {  1,x4505, },  /* x75[2].attach */ {  0,x4512, }, },
	/* x75[3] */ {  "walk",  /* x75[3].body */ {  6,x4531, },  /* x75[3].back_foot */ {  6,x4538, },  /* x75[3].front_foot */ {  6,x4545, },  /* x75[3].attach */ {  0,x4552, }, },
	/* x75[4] */ {  "hammer_swing",  /* x75[4].body */ {  0,x4651, },  /* x75[4].back_foot */ {  0,x4658, },  /* x75[4].front_foot */ {  0,x4665, },  /* x75[4].attach */ {  5,x4672, }, },
	/* x75[5] */ {  "ninja_swing",  /* x75[5].body */ {  0,x4706, },  /* x75[5].back_foot */ {  0,x4713, },  /* x75[5].front_foot */ {  0,x4720, },  /* x75[5].attach */ {  6,x4727, }, },
};
static CDataSprite* *x4884 = 0;
static CDataSprite* x5021[] = {
	&x44[29],
	&x44[30],
	&x44[31],
};
static CDataSprite* x5206[] = {
	&x44[35],
	&x44[36],
	&x44[37],
};
static CDataSprite* *x5391 = 0;
static CDataSprite* *x5528 = 0;
static CDataSprite* x5665[] = {
	&x44[52],
	&x44[53],
	&x44[54],
};
static CDataWeaponspec x1887[] = {
	/* x1887[0] */ {  "hammer",  &x44[41],  &x44[42],  &x44[43],  0,x4884,  96,  125,  10,  0,  3,  4.000000f,  -20.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[1] */ {  "gun",  &x44[26],  &x44[27],  &x44[28],  3,x5021,  64,  125,  10,  500,  1,  32.000000f,  4.000000f,  50.000000f,  6.000000f,  5.000000f, },
	/* x1887[2] */ {  "shotgun",  &x44[32],  &x44[33],  &x44[34],  3,x5206,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  70.000000f,  6.000000f,  5.000000f, },
	/* x1887[3] */ {  "grenade",  &x44[38],  &x44[39],  &x44[40],  0,x5391,  96,  500,  10,  0,  1,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[4] */ {  "rifle",  &x44[47],  &x44[48],  &x44[49],  0,x5528,  92,  800,  10,  0,  5,  24.000000f,  -2.000000f,  0.000000f,  0.000000f,  5.000000f, },
	/* x1887[5] */ {  "ninja",  &x44[44],  &x44[45],  &x44[46],  3,x5665,  96,  800,  10,  0,  9,  0.000000f,  0.000000f,  40.000000f,  -4.000000f,  5.000000f, },
};
